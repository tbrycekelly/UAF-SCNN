...
#include <opencv2/opencv.hpp> //TBK
#include <iostream> //TBK
#include <opencv2/core/core.hpp> //TBK
#include <opencv2/highgui/highgui.hpp> //TBK
#include <opencv2/imgproc/imgproc.hpp> //TBK

using namespace std; //TBK
using namespace cv; //TBK
